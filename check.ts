function checkStatus(arr) {
    if (arr[1] == "X" && arr[2] == "X" && arr[3] == "X" || arr[4] == "X" && arr[5] == "X" && arr[6] == "X" ||
        ...
        let v = parseInt(document.getElementById("pw").innerHTML);
        v++;
        ...
        let v = parseInt(document.getElementById("cw").innerHTML);
        v++;
        ...
        let v = parseInt(document.getElementById("nw").innerHTML);
        v++;
